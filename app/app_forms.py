...
class TreatmentForm(FlaskForm):
    patient = SelectField("Select Patient", coerce=int) 
    diagnosis = TextAreaField('Diagnosis', validators=[DataRequired(), Length(min=10)])
    prescription = TextAreaField('Prescription', validators=[DataRequired(), Length(min=5)])
